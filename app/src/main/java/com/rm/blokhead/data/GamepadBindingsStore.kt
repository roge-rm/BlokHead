...
fun defaultGamepadBindings(): Map<GamepadAction, Int?> = mapOf(
    ...
    GamepadAction.RotateXPositive to KeyEvent.KEYCODE_BUTTON_A,
    GamepadAction.RotateXNegative to KeyEvent.KEYCODE_BUTTON_Y,
    GamepadAction.RotateYPositive to KeyEvent.KEYCODE_BUTTON_X,
    GamepadAction.RotateYNegative to KeyEvent.KEYCODE_BUTTON_B,
